...
<table id="customers">
        ...
        ResultSet rs=st.executeQuery("select * from cart inner join addproduct where cart.p_id=addproduct.id and cart.orderdate is not NULL and cart.status='cancel'");
        while(rs.next())
        {
        %>
